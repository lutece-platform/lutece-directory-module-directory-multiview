...
INSERT INTO core_admin_right (id_right,name,level_right,admin_url,description,is_updatable,plugin_name,id_feature_group,icon_url,documentation_url, id_order ) VALUES 
('DIRECTORY_MULTIVIEW','module.directory.multiview.adminFeature.directoryMultiView.name',3,'jsp/admin/plugins/directory-multiview/ManageMultiDirectoryRecords.jsp','module.directory.multiview.adminFeature.directoryMultiView.description',0,'directory-multiview',NULL,NULL,NULL,4);
